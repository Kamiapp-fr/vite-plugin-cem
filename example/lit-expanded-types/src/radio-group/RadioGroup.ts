...
export class RadioGroup extends LitElement {
  ...
  @property({ type: String }) variants: Variants = 'primary';

  /** This is a test for external d.ts options */
  @property({ type: String }) external: Test = 'value1';

  /** This is a test for external .ts options */
  @property({ type: String }) external2: Example = 'value4';

  /** This is a test for external .ts options */
  @property({ type: String }) external3: Test3 = 'value8';

  /** This is a test for options from an object */
  @property({ type: String }) complex: ComplexObjectType = 'single';
  ...
  /** This is a test for options from an object */
  @property({ attribute: 'complex-union' }) complexUnion!: ChildSize;
